...
\hlstd{bP}  \hlcom{# bP is a tibble so only 10 lines are printed (a limited number of variables, too)}
\end{alltt}
\end{kframe}
\end{knitrout}
  \subsubsection{Notes:}
...
\hlstd{bP} \hlkwb{<-} \hlstd{bP} \hlopt{%>%} \hlkwd{drop_na}\hlstd{()}  \hlcom{# Use this to remove all cases (rows) with at least one NA from}
...
\hlkwd{kable}\hlstd{(}\hlkwd{data.frame}\hlstd{(}\hlkwc{Rnorm} \hlstd{=} \hlkwd{rnorm}\hlstd{(}\hlnum{5}\hlstd{),} \hlkwc{Runif} \hlstd{=} \hlkwd{runif}\hlstd{(}\hlnum{5}\hlstd{),} \hlkwc{Rbeta} \hlstd{=} \hlkwd{rbeta}\hlstd{(}\hlnum{5}\hlstd{,} \hlnum{.5}\hlstd{,} \hlnum{.5}\hlstd{),}
                 \hlkwc{RPoisson} \hlstd{=} \hlkwd{rpois}\hlstd{(}\hlnum{5}\hlstd{,} \hlnum{0.5}\hlstd{)))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{hhDf} \hlkwb{<-} \hlkwd{bind_rows}\hlstd{(hhDf,hhDf[}\hlnum{2}\hlstd{,])}  \hlcom{# bind_rows adds rows of equal length to the data frame}
\hlstd{hhDf}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlstd{bPgather} \hlkwb{<-} \hlstd{bP} \hlopt{%>%}
             ...
             \hlkwd{gather}\hlstd{(}\hlkwc{key} \hlstd{= variable,} \hlkwc{value} \hlstd{= value, disability, bmi, wHR)} \hlcom{# Convert to long}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlkwa{for} \hlstd{(i} \hlkwa{in} \hlkwd{levels}\hlstd{(df}\hlopt{$}\hlstd{country))\{}        \hlcom{# loop through the levels of country}
  \hlstd{jj} \hlkwb{<-} \hlstd{jj} \hlopt{+} \hlnum{1}                        \hlcom{# jj will take values 1-6 through the loop}
  ...
  \hlstd{df}\hlopt{$}\hlstd{PPP[df}\hlopt{$}\hlstd{country} \hlopt{==} \hlstd{i]} \hlkwb{<-} \hlstd{df}\hlopt{$}\hlstd{PPP[df}\hlopt{$}\hlstd{country}\hlopt{==}\hlstd{i]}\hlopt{/}\hlstd{dd[jj]}\hlopt{*}\hlnum{100.} \hlcom{# divide PPP for country i   }
                                                \hlcom{# by the max PPP for country i}
\hlstd{\}}
...
\hlstd{p} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= bP,} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= bmi,} \hlkwc{y} \hlstd{= wHR,} \hlkwc{shape} \hlstd{= residence,}
                           \hlkwc{colour} \hlstd{= agegr,} \hlkwc{group} \hlstd{=} \hlnum{1}\hlstd{))} \hlopt{+}
  ...
  \hlkwd{stat_poly_eq}\hlstd{(}\hlkwc{formula} \hlstd{= my.formula,}
               \hlkwd{aes}\hlstd{(}\hlkwc{label} \hlstd{=} \hlkwd{paste}\hlstd{(..eq.label.., ..rr.label..,}
                                 \hlkwc{sep} \hlstd{=} \hlstr{"~~~"}\hlstd{,}\hlkwc{x}\hlstd{=}\hlnum{30}\hlstd{,} \hlkwc{y}\hlstd{=}\hlnum{1.4}\hlstd{),} \hlkwc{y}\hlstd{=}\hlnum{1.4}\hlstd{),}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{ggplot}\hlstd{(China)} \hlopt{+} \hlkwd{geom_point}\hlstd{(}\hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= bmi,} \hlkwc{y} \hlstd{= bmi),} \hlkwc{colour} \hlstd{=} \hlstr{"red"}\hlstd{)} \hlopt{+}
  \hlkwd{geom_point}\hlstd{(}\hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= bmi,} \hlkwc{y} \hlstd{= fitsLM1),} \hlkwc{colour} \hlstd{=} \hlstr{"dark green"}\hlstd{,} \hlkwc{alpha} \hlstd{=} \hlnum{0.1}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{p} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(China,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=fitsLM1,} \hlkwc{y} \hlstd{= residLM1))} \hlopt{+}
  \hlkwd{geom_point}\hlstd{(}\hlkwc{alpha} \hlstd{=} \hlnum{0.1}\hlstd{,} \hlkwc{colour} \hlstd{=} \hlstr{"brown"}\hlstd{)}
\hlstd{p}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{p} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(China,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=residLM1))} \hlopt{+}
  \hlkwd{geom_histogram}\hlstd{(}\hlkwc{binwidth} \hlstd{=} \hlnum{0.5}\hlstd{,} \hlkwc{colour} \hlstd{=} \hlstr{"brown"}\hlstd{,} \hlkwc{fill} \hlstd{=} \hlstr{"beige"} \hlstd{)}
\hlstd{p}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlkwd{plot}\hlstd{(SF)}                                                      \hlcom{# 3.}
\hlstd{cMap2} \hlkwb{<-} \hlkwd{fortify}\hlstd{(SF)}                                          \hlcom{# 4.}
\hlkwd{head}\hlstd{(cMap2)}                                                   \hlcom{# 5.}

\hlstd{myMap} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(cMap2,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=long,} \hlkwc{y}\hlstd{= lat,} \hlkwc{group} \hlstd{= group))}
  \hlopt{+} \hlkwd{geom_path}\hlstd{()}

\hlstd{myMap} \hlkwb{<-} \hlstd{myMap} \hlopt{+} \hlkwd{coord_map}\hlstd{(}\hlstr{"mercator"}\hlstd{)}

\hlstd{myMap} \hlkwb{=} \hlstd{myMap} \hlopt{+} \hlkwd{coord_map}\hlstd{(}\hlstr{"ortho"}\hlstd{,} \hlkwc{orientation} \hlstd{=} \hlkwd{c}\hlstd{(}\hlopt{-}\hlnum{34}\hlstd{,} \hlnum{151}\hlstd{,} \hlnum{0}\hlstd{))}
...
\hlstd{wmap_df} \hlkwb{<-} \hlkwd{fortify}\hlstd{(wmap,} \hlkwc{regions} \hlstd{= ISO_A2)} \hlcom{# convert SpatialPolygonsDataFrame to dataframe}
\hlkwd{head}\hlstd{(wmap_df)}
